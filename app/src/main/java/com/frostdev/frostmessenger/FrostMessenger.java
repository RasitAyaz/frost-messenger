...
import com.frostdev.frostmessenger.ActivityHierarchy.FrostActivity;
import com.frostdev.frostmessenger.Dialog.LoadingDialog;
...
public class FrostMessenger extends Application {
    ...
    public static final String TAG_FROST_MESSENGER = "FrostMessenger";
    ...
    private FrostActivity currentActivity;
    ...
    public void updateUserStatus(String status) {
        if (loggedUser == null || loggedUser.getStatus().equals(status)) return;
    ...
    public void readLoggedUser(Activity activity) {
        ...
        userRef.get().addOnSuccessListener(documentSnapshot -> {
            ...
            loggedUser = documentSnapshot.toObject(FrostUser.class);
    ...
    public void signOut(Activity activity) {
        ...
        userRef.update(userMap).addOnSuccessListener(aVoid -> {
            ...
            deleteCache(FrostMessenger.this);

            auth.signOut();
            loggedUser = null;

            if (activity instanceof MainActivity || activity instanceof ChatActivity) {
                activity.startActivity(new Intent(FrostMessenger.this, WelcomeActivity.class));
                activity.finish();
            }
        });
    }
    ...
    public void setCurrentActivity(FrostActivity currentActivity) {
    ...
    public FrostUser getLoggedUser() {
        return loggedUser;
    }
