...
import static com.frostdev.frostmessenger.FrostMessenger.CH_MESSAGE;
...
public class FrostMessagingService extends FirebaseMessagingService {
    @Override
    ...
    private void showNotification(RemoteMessage remoteMessage) {
        ...
        FrostMessenger application = (FrostMessenger) getApplication();
        if (application != null) {
